...
ActiveRecord::Schema.define(version: 2019_08_21_061828) do
  ...
  create_table "time_checks", id: :string, force: :cascade do |t|
    t.string "user_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
    t.index ["user_id"], name: "index_time_checks_on_user_id"
  end
